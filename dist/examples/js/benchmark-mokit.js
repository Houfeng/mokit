...
var data = new Array(1000).fill('');

var App = (_dec = __WEBPACK_IMPORTED_MODULE_3_mokit__["b" /* default */].template('<ul>\n  <li m:each="index in data">{{index}}</li>\n  </ul>'), _dec(_class = function (_mokit$Component) {
  __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_inherits___default()(App, _mokit$Component);
  ...
  function App() {
    ...
    return _ret = (_temp = (_this = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_possibleConstructorReturn___default()(this, _mokit$Component.call.apply(_mokit$Component, [this].concat(args))), _this), _this.data = data, _temp), __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_possibleConstructorReturn___default()(_this, _ret);
  }

  return App;
}(__WEBPACK_IMPORTED_MODULE_3_mokit__["b" /* default */].Component)) || _class);
...
/***/ })
/******/ ]);
//# sourceMappingURL=benchmark-mokit.js.map