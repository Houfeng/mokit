...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(36)(Function.call, __webpack_require__(43).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
// CONCATENATED MODULE: /private/var/folders/7d/bf741r6j1psb64d_yd0zn_mh0000gn/T/$info-42102965bb72f7a2e07815dfee3e2793.js
/* harmony default export */ var $info_42102965bb72f7a2e07815dfee3e2793 = ({ "name": "mokit", "version": "4.0.0-alpha12" });
...
var error_LibError = function (_Error) {
  ...
  function LibError(message) {
    ...
    return possibleConstructorReturn_default()(this, _Error.call.apply(_Error, [this, '[' + $info_42102965bb72f7a2e07815dfee3e2793.name + '] ' + message].concat(other)));
  }
...
/* unused concated harmony import null */
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, false, function() { return watch; });
...
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "c", function() { return dependencies; });
/* unused concated harmony import null */
...
/* unused concated harmony import bootstrap */
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, false, function() { return bootstrap; });
...
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, false, function() { return $config_a10b4978dbbf03e8bab090cc9cabd934; });
...
copy($info_42102965bb72f7a2e07815dfee3e2793, bootstrap);
...
/* harmony default export */ var src = __webpack_exports__["b"] = (bootstrap);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_mokit__ = __webpack_require__(81);




var _dec, _dec2, _dec3, _class, _desc, _value, _class2, _dec4, _dec5, _class4;
...
var Text = (_dec = Object(__WEBPACK_IMPORTED_MODULE_3_mokit__["e" /* template */])('<h5 m:on:click="click()">Text: {{content}}</h5>'), _dec2 = Object(__WEBPACK_IMPORTED_MODULE_3_mokit__["d" /* on */])('ready'), _dec3 = Object(__WEBPACK_IMPORTED_MODULE_3_mokit__["d" /* on */])('destroyed'), _dec(_class = (_class2 = function (_Component) {
  __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_inherits___default()(Text, _Component);
  ...
  function Text() {
    ...
    return _ret = (_temp = (_this = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_possibleConstructorReturn___default()(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.content = '', _temp), __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_possibleConstructorReturn___default()(_this, _ret);
  }

  Text.prototype.onReady = function onReady() {
    console.log('ready');
  };

  Text.prototype.onDestroy = function onDestroy() {
    console.log('destroyed');
  };

  Text.prototype.click = function click() {
    this.emit('xxxx');
  };

  return Text;
}(__WEBPACK_IMPORTED_MODULE_3_mokit__["a" /* Component */]), (_applyDecoratedDescriptor(_class2.prototype, 'onReady', [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, 'onReady'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'onDestroy', [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, 'onDestroy'), _class2.prototype)), _class2)) || _class);
var App = (_dec4 = Object(__WEBPACK_IMPORTED_MODULE_3_mokit__["e" /* template */])('<div>\n  <div m:if="state">\n    <m:text m:on:xxxx="toggle()" data-id="a" m:prop:content="\'1\uFF09Hello world!\'"/>\n    <m:text data-id="b" m:prop:content="\'2\uFF09Hello world!\'"/>\n  </div>\n  <button m:on:click="toggle()">toggle</button>\n</div>'), _dec5 = Object(__WEBPACK_IMPORTED_MODULE_3_mokit__["c" /* dependencies */])({ Text: Text }), _dec4(_class4 = _dec5(_class4 = function (_Component2) {
  __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_inherits___default()(App, _Component2);
  ...
  function App() {
    ...
    return _ret2 = (_temp2 = (_this2 = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_possibleConstructorReturn___default()(this, _Component2.call.apply(_Component2, [this].concat(args))), _this2), _this2.state = true, _temp2), __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_possibleConstructorReturn___default()(_this2, _ret2);
  }

  App.prototype.toggle = function toggle() {
    this.state = !this.state;
    console.log(window.performance.memory);
  };

  return App;
}(__WEBPACK_IMPORTED_MODULE_3_mokit__["a" /* Component */])) || _class4) || _class4);


window.app = Object(__WEBPACK_IMPORTED_MODULE_3_mokit__["b" /* default */])(App, mountNode);
