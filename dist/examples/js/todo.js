...
// EXTERNAL MODULE: ./src/index.js + 53 modules
...
// CONCATENATED MODULE: ./examples/todo/list/index.js
...
var template = src["b" /* default */].template;
var list_List = (_dec = template(__webpack_require__(132)), _dec(_class = function (_mokit$Component) {
  ...
  return List;
}(src["b" /* default */].Component)) || _class);

// CONCATENATED MODULE: ./examples/todo/app/index.js
...
var on = src["b" /* default */].on,
    watch = src["b" /* default */].watch,
    app_template = src["b" /* default */].template,
    dependencies = src["b" /* default */].dependencies;
var app_App = (app__dec = app_template(__webpack_require__(133)), _dec2 = dependencies({ List: list_List }), _dec3 = on('init'), _dec4 = watch('list'), _dec5 = watch('type'), app__dec(app__class = _dec2(app__class = (_class2 = function (_mokit$Component) {
  ...
  return App;
}(src["b" /* default */].Component), (_applyDecoratedDescriptor(_class2.prototype, 'onInit', [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, 'onInit'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'saveList', [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, 'saveList'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'saveType', [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, 'saveType'), _class2.prototype)), _class2)) || app__class) || app__class);

// EXTERNAL MODULE: ./examples/todo/assets/todo.less
var todo = __webpack_require__(134);
var todo_default = /*#__PURE__*/__webpack_require__.n(todo);

// CONCATENATED MODULE: ./examples/todo/index.js




console.time('用时');
window.todo = Object(src["b" /* default */])(app_App, mountNode);
console.timeEnd('用时');
