...
var App = (_dec = (0, _mokit.template)('\n<div>{{name}}-{{demo}}</div>\n'), _dec2 = (0, _mokit.on)('init'), _dec3 = (0, _mokit.watch)('name'), _dec(_class = (_class2 = function (_Component) {
  ...
  function App() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.demo = true, _this.name = "test", _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
  }
  ...
  return App;
}(_mokit.Component), (_applyDecoratedDescriptor(_class2.prototype, 'init', [_dec2], (0, _getOwnPropertyDescriptor2.default)(_class2.prototype, 'init'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'printName', [_dec3], (0, _getOwnPropertyDescriptor2.default)(_class2.prototype, 'printName'), _class2.prototype)), _class2)) || _class);


window.app = (0, _mokit.bootstrap)(App, document.body);
