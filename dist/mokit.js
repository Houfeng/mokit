...
},{"../template":36,"cify":39,"ntils":40}],2:[function(require,module,exports){
const Class = require('cify');
const Template = require('../template');
...
function Component(classOpts) {
  ...
  var extendObjects = classOpts.extends;
  delete classOpts.extends;
  if (extendObjects && !utils.isArray(extendObjects)) {
    extendObjects = [extendObjects];
  } else {
    extendObjects = [];
  }
  extendObjects.forEach(function (extendObject) {
    extendObject = extendObject._options || extendObject;
    utils.mix(classOpts, extendObject, true, null, 2, true);
  });
...
},{"../events":7,"../observer":11,"../template":36,"../watcher":38,"./component-directive":1,"./components":3,"cify":39,"ntils":40}],3:[function(require,module,exports){
module.exports = {
  View: require('./view')
};
...
module.exports = View;
},{"../component":2,"ntils":40}],5:[function(require,module,exports){
const Component = require('./component');
...
},{"cify":39,"ntils":40}],7:[function(require,module,exports){
...
},{"./emitter":6,"ntils":40}],9:[function(require,module,exports){
...
module.exports = Component;
},{"./component":5,"./events":7,"./info.json":10,"./observer":11,"./router":13,"./template":36,"./watcher":38,"ntils":40}],10:[function(require,module,exports){
module.exports={"name":"mokit","version":"3.0.0-rc6"}
...
},{"../events":7,"cify":39,"ntils":40}],12:[function(require,module,exports){
const Class = require('cify');
const EventEmitter = require('../../events');
...
},{"../../events":7,"cify":39}],13:[function(require,module,exports){
const utils = require('ntils');
const Class = require('cify');
...
},{"./drivers/hash":12,"./router":15,"./router-view":14,"cify":39,"ntils":40}],14:[function(require,module,exports){
const Class = require('cify');
...
},{"../component":5,"cify":39}],15:[function(require,module,exports){
const utils = require("ntils");
...
/*end*/
},{"ntils":40}],16:[function(require,module,exports){
const Class = require('cify');
...
},{"./directive":17,"./directives":23,"./expression":35,"cify":39,"ntils":40}],17:[function(require,module,exports){
const Class = require('cify');
const utils = require('ntils');
const Expression = require('./expression');
...
},{"./expression":35,"cify":39,"ntils":40}],18:[function(require,module,exports){
const Directive = require('../directive');
...
},{"../directive":17}],19:[function(require,module,exports){
const Directive = require('../directive');
...
},{"../directive":17}],20:[function(require,module,exports){
const Directive = require('../directive');
...
},{"../directive":17}],21:[function(require,module,exports){
const Directive = require('../directive');
...
},{"../directive":17}],22:[function(require,module,exports){
const Directive = require('../directive');
...
},{"../directive":17}],23:[function(require,module,exports){
module.exports = [
  require('./text'),
  require('./attr'),
  require('./each'),
...
},{"./attr":18,"./cloak":19,"./each":20,"./id":21,"./if":22,"./inner-html":24,"./inner-text":25,"./model-checkbox":26,"./model-editable":27,"./model-input":28,"./model-radio":29,"./model-select":30,"./on":31,"./prevent":32,"./prop":33,"./text":34}],24:[function(require,module,exports){
const Directive = require('../directive');
...
},{"../directive":17}],25:[function(require,module,exports){
const Directive = require('../directive');
...
},{"../directive":17}],26:[function(require,module,exports){
const Directive = require('../directive');
const EventEmitter = require('../../events');
...
},{"../../events":7,"../directive":17}],27:[function(require,module,exports){
const Directive = require('../directive');
const EventEmitter = require('../../events');
...
},{"../../events":7,"../directive":17}],28:[function(require,module,exports){
const Directive = require('../directive');
const EventEmitter = require('../../events');
...
},{"../../events":7,"../directive":17}],29:[function(require,module,exports){
const Directive = require('../directive');
const EventEmitter = require('../../events');
...
},{"../../events":7,"../directive":17}],30:[function(require,module,exports){
const Directive = require('../directive');
const EventEmitter = require('../../events');
...
},{"../../events":7,"../directive":17}],31:[function(require,module,exports){
const Directive = require('../directive');
const EventEmitter = require('../../events');
...
},{"../../events":7,"../directive":17}],32:[function(require,module,exports){
const Directive = require('../directive');
...
},{"../directive":17}],33:[function(require,module,exports){
const Directive = require('../directive');
...
},{"../directive":17}],34:[function(require,module,exports){
const Directive = require('../directive');
const Expression = require('../expression');
...
},{"../directive":17,"../expression":35}],35:[function(require,module,exports){
const Class = require('cify');
const utils = require('ntils');
...
},{"cify":39,"ntils":40}],36:[function(require,module,exports){
...
},{"./compiler":16,"./directive":17,"./directives/":23,"./expression":35,"./template":37}],37:[function(require,module,exports){
const Class = require('cify');
const Observer = require('../observer');
const EventEmitter = require('../events');
const Compiler = require('./compiler');
...
module.exports = Template;
},{"../events":7,"../observer":11,"./compiler":16,"cify":39}],38:[function(require,module,exports){
const Class = require('cify');
const utils = require('ntils');
...
},{"cify":39,"ntils":40}],39:[function(require,module,exports){
const utils = require('ntils');
...
},{"ntils":40}],40:[function(require,module,exports){
(function (ntils) {
